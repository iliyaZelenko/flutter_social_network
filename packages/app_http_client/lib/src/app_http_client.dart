...
// import 'package:app_http_client/src/http_method.dart' as myHttpMethod;
...
//     required myHttpMethod.HttpMethod method,
//     bool? fakeIsolate,
...
//       switch (method) {
//         case myHttpMethod.HttpMethod.get:
//           request = super.get(
//             host: requestHost,
//             path: path,
//             query: query,
...
//           );
//           break;
//         case myHttpMethod.HttpMethod.post:
//           request = super.post(
//             host: requestHost,
//             path: path,
//             query: query,
...
//           );
//           break;
//         case myHttpMethod.HttpMethod.put:
//           request = super.put(
//             host: requestHost,
//             path: path,
//             query: query,
...
//           );
//           break;
//         case myHttpMethod.HttpMethod.delete:
...
//           );
//           break;
//         case myHttpMethod.HttpMethod.patch:
//           request = super.patch(
//             host: requestHost,
//             path: path,
//             query: query,
...
//           );
//           break;
//         case myHttpMethod.HttpMethod.filePost:
...
//               body: jsonEncode({'refresh': _tokensStorage.refreshToken}),
//               headers: {
...
//       method: myHttpMethod.HttpMethod.get,
//       host: host,
//       path: path,
//       query: query,
//       headers: headers,
...
//   }) {
//     return _performRequest(
//       method: myHttpMethod.HttpMethod.post,
//       host: host,
//       path: path,
//       query: query,
//       headers: headers,
...
//   }) {
//     return _performRequest(
//       method: myHttpMethod.HttpMethod.put,
//       host: host,
//       path: path,
//       query: query,
//       headers: headers,
...
//   }) {
//     return _performRequest(
//       method: myHttpMethod.HttpMethod.delete,
//       host: host,
//       path: path,
//       query: query,
//       headers: headers,
...
//   }) {
//     return _performRequest(
//       method: myHttpMethod.HttpMethod.patch,
//       host: host,
//       path: path,
//       query: query,
//       headers: headers,
...
//     bool handleOnUnauthorized = true,
//     bool? fakeIsolate,
//     required covariant Iterable<MultipartBundleFile>? files,
//     Map<String, String>? fields,
//   }) {
//     return _performRequest(
//       method: myHttpMethod.HttpMethod.filePost,
//       host: host,
//       path: path,
//       headers: headers,
//       query: query,
